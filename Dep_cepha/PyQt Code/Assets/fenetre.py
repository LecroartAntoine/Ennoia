    ...
    def calc_dif(self):
        ...
        try:
            for value in self.df.index[:len(self.break_point_inf)]:
                row = [value[2:]]
                row.append(float(self.df[self.df.index == (value[:1] + '1' + value[2:])]['X\n\n'].values - self.df[self.df.index == value]['X\n\n'].values))
                row.append(float(self.df[self.df.index == (value[:1] + '1' + value[2:])]['Y\n\n'].values - self.df[self.df.index == value]['Y\n\n'].values))
                row.append(float(self.df[self.df.index == (value[:1] + '1' + value[2:])]['Z\n\n'].values - self.df[self.df.index == value]['Z\n\n'].values))
